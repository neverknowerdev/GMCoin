...
const config = {
    ...
    networks: {
        ...
        baseSepolia: {
            ...
            accounts: [process.env.BASE_PROD_PRIVATE_KEY, process.env.BASE_PROD_FEE_PRIVATE_KEY, process.env.BASE_TESTNET_LEARNING_PRIVATE_KEY], // Your wallet private key (from .env file)
        },
