...
async function main(): Promise<void> {
    ...
    const contractV3 = await ethers.getContractFactory("GMCoinV3");
    ...
    const upgraded = await upgrades.upgradeProxy('0x6Ec55d72eAA6792380a627a2a4aD1aae8EC96F2d', contractV3, {
        call: {
            fn: "initialize3",
            args: [7, 0, 100],
        }
